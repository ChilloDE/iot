...
namespace Iot.Device.Ssd13xx.Commands.Shared1x06Commands
{
    ...
    /// </summary>
    public abstract class SetDisplayClockDivideRatioOscillatorFrequency : IShared1x06Command
    {
        /// <summary>
        ...
        internal SetDisplayClockDivideRatioOscillatorFrequency(byte displayClockDivideRatio = 0x00, byte oscillatorFrequency = 0x05)
        {
